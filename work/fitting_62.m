function [androgenError, psaError] = fitting_62
%{
...
% Declare global variable that will take the error values from objective
% function
global errorPSA
global errorAND
...
options = optimset('Algorithm','interior-point','TolX',1e-4,'TolFun',1e-4,'TolCon'...
    ,1e-4,'MaxIter',1000);                % Optimizer Options orig: 1e-13
...
for yy = 1:2 %% Uncomment this to recover the full code for all 4 models.
...
%%%%%% Retrieve androgen and PSA errors using global variables %%%%%%%%%%
if yy~=3
...
%%%%%%%%%%%%%%%%%%% ODE system %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dX = (ux - Dx  - abs(dd1)*X)*X - 2*Lm*X + Lm*Y;
