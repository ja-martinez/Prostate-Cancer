...
% for yy = 1:4 %% Uncomment this to recover the full code for all 4 models.
...
% patients = cell(1,62);                     % creates a cell array to hold patient data

%Uncomment the above 4 lines to run through all patients, and comment the
%three lines below. Note that only about 30 patients in the above lists
%will be used for the final forecasting.
LIST = [17]; % patient numbers 
totalPatients = length(LIST);              % total number of patients  
...
% end %Uncomment this if the for loop is uncommented.
